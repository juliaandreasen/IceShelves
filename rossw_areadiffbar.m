...
A=dlmread('rossw_area1.prn'); %read in area change datasets from ice shelf
...
ylim([200 500]); %set the area difference range on the y-axis
title('Yearly Ross West Ice Shelf Area Difference 2009-2019'); %create a graph title

% module C: save resulting figure
filename = 'rossw_areadiffbar.png' %define the filename
saveas(fHand,'rossw_areadiffbar.png') %save the bar graph figure under this name
