...
title('Ross West Ice Shelf Area Change 2009-2019'); %create a graph title
...
for i=1:length(x)
    ...
    ylim([305000 312000]); %set the area range on the y-axis
...
filename = 'rossw_areachange.gif'; %specify the output file name
