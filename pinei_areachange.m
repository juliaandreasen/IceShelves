...
title('Pine Island Ice Shelf Area Change 2009-2019'); %create a graph title
...
for i=1:length(x)
    ...
    ylim([5800 7500]); %set the area range on the y-axis
...
filename = 'pinei_areachange.gif'; %specify the output file name
