...
A=dlmread('thwaites_area1.prn'); %read in area change datasets from ice shelf
...
ylim([-2900 800]); %set the area difference range on the y-axis
title('Yearly Thwaites Ice Shelf Area Difference 2009-2019'); %create a graph title

% module C: save resulting figure
filename = 'thwaites_areadiffbar.png' %define the filename
saveas(fHand,'thwaites_areadiffbar.png') %save the bar graph figure under this name
