...
title('Amery Ice Shelf Area Change 2009-2019'); %create a graph title
...
for i=1:length(x)
    ...
    ylim([60000 64000]); %set the area range on the y-axis
...
filename = 'amery_areachange.gif'; %specify the output file name
