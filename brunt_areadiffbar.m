...
A=dlmread('brunt_area1.prn'); %read in area change datasets from ice shelf
...
ylim([-80 400]); %set the area difference range on the y-axis
title('Yearly Brunt Ice Shelf Area Difference 2009-2019'); %create a graph title

% module C: save resulting figure
filename = 'brunt_areadiffbar.png' %define the filename
saveas(fHand,'brunt_areadiffbar.png') %save the bar graph figure under this name
