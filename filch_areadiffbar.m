...
ylim([0 350]); %set the area difference range on the y-axis
title('Yearly Filchner Ice Shelf Area Difference 2009-2019'); %create a graph title

% module C: save resulting figure
filename = 'filch_areadiffbar.png' %define the filename
saveas(fHand,'filch_areadiffbar.png') %save the bar graph figure under this name
