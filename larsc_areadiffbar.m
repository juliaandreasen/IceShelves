...
A=dlmread('larsc_area1.prn'); %read in area change datasets from ice shelf
...
ylim([-6500 1000]); %set the area difference range on the y-axis
title('Yearly Larsen C Ice Shelf Area Difference 2009-2019'); %create a graph title

% module C: save resulting figure
filename = 'larsc_areadiffbar.png' %define the filename
saveas(fHand,'larsc_areadiffbar.png') %save the bar graph figure under this name
