...
title('Larsen C Ice Shelf Area Change 2009-2019'); %create a graph title
...
for i=1:length(x)
    ...
    ylim([40000 50000]); %set the area range on the y-axis
...
filename = 'larsc_areachange.gif'; %specify the output file name
