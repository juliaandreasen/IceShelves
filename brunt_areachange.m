...
title('Brunt Ice Shelf Area Change 2009-2019'); %create a graph title
...
for i=1:length(x)
    ...
    ylim([36000 40000]); %set the area range on the y-axis
...
filename = 'brunt_areachange.gif'; %specify the output file name
