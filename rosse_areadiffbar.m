...
A=dlmread('rosse_area1.prn'); %read in area change datasets from ice shelf
...
ylim([130 260]); %set the area difference range on the y-axis
title('Yearly Ross East Ice Shelf Area Difference 2009-2019'); %create a graph title

% module C: save resulting figure
filename = 'rosse_areadiffbar.png' %define the filename
saveas(fHand,'rosse_areadiffbar.png') %save the bar graph figure under this name
