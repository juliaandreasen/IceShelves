...
ylim([0 900]); %set the area difference range on the y-axis
title('Yearly Ronne Ice Shelf Area Difference 2009-2019'); %create a graph title

% module C: save resulting figure
filename = 'ronne_areadiffbar.png' %define the filename
saveas(fHand,'ronne_areadiffbar.png') %save the bar graph figure under this name
